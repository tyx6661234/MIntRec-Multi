"""Triplet-margin hinge loss over cosine similarity (from DLF, AAAI 2025).

`ids` holds one label per row of `feats`; pairs with equal ids are pulled
together, pairs with different ids are pushed apart with margin
0.15 * |id_i - id_j|.
"""
import torch
